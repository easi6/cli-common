...
export const DELIVERY_SUMMARY_STRINGS = {
  ...
  [DELIVERY_SUMMARY.COUNT_DROPOFF_ASSIGNED_TOTAL]: 'Dropoff Assigned on Total',
  [DELIVERY_SUMMARY.COUNT_DROPOFF_ASSIGNED_ON_REQUEST_TIME_LIMIT]: 'Dropoff Assigned on Request Time Limit',
...
export const DELIVERY_EXPORT_TYPE = {
...
export const DELIVERY_EXPORT_TYPE_ALL = [DELIVERY_EXPORT_TYPE.SENDER_DELIVERY_SUMMARY];
